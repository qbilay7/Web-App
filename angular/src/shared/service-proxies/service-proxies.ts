...
export class StudentServiceProxy {
     ...
     * @return Success
     */
    createStudent(body: CreateStudentDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    updateStudent(body: UpdateStudentDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<Student> {
    ...
    protected processGet(response: HttpResponseBase): Observable<Student> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
